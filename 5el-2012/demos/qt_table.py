...
def add_plot(windows, plot_window):
    dw = QtGui.QDockWidget(plot_window.component.title, windows)
    ...
    windows.addDockWidget(QtCore.Qt.TopDockWidgetArea, dw)
...
def main():
    ...
    #add_plot(windows, create_chaco_plot(windows, data, ('x','y'), 'scatter'))

    ew = create_chaco_plot(windows, data, ('z','y'))
    dw = QtGui.QDockWidget(ew.component.title, windows)
    ...
    windows.setCentralWidget(create_chaco_plot(windows, data, ('z','y'), 'scatter').control)
    #windows.setCentralWidget(QtGui.QPushButton())
    windows.show()
    app.exec_()
